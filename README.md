...
Check the [releases](https://github.com/dhomas1/owncloud/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/dhomas1/owncloud.git
cd owncloud
./build.sh
ls -la *.tgz
```
